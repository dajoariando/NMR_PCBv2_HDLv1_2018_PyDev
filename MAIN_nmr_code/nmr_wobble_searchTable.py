...
tblMtchNtwrk = '/hw_opt/PARAM_NMR_AFE_v2.csv'  # table for the capacitance matching network capacitance values
...
nmrObj.deassertControlSignal( 0xFFFF )

nmrObj.assertControlSignal( nmrObj.PSU_5V_TX_N_EN_msk | nmrObj.PSU_5V_ADC_EN_msk | nmrObj.PSU_5V_ANA_P_EN_msk | nmrObj.PSU_5V_ANA_N_EN_msk )
...
def runExpt( cparVal, cserVal, minReflxTable ):
    ...
    if keepRawData:
        ...
        shutil.rmtree ( data_parent_folder + '/' + meas_folder[0] )  # move the data folder
    else:
